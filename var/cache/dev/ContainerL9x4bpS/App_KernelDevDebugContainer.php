...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getUserControllerService()
    {
        ...
        return $this->services['App\\Controller\\UserController'] = new \App\Controller\UserController(($this->privates['App\\Repository\\UserRepository'] ?? $this->getUserRepositoryService()), new \Symfony\Component\Security\Core\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getSecurity_Authentication_GuardHandlerService()
    {
        ...
        $this->privates['security.authentication.guard_handler'] = $instance = new \Symfony\Component\Security\Guard\GuardAuthenticatorHandler(($this->services['security.token_storage'] ?? $this->getSecurity_TokenStorageService()), ($this->services['event_dispatcher'] ?? $this->getEventDispatcherService()), [0 => 'login', 1 => 'api', 2 => 'user']);
