...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getPostControllerService()
    {
        ...
        return $this->services['App\\Controller\\PostController'] = new \App\Controller\PostController(($this->privates['App\\Repository\\PostRepository'] ?? $this->getPostRepositoryService()), ($this->privates['security.helper'] ?? $this->getSecurity_HelperService()));
    }
    ...
    /**
     * Gets the private '.service_locator.hEC2953' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_HEC2953Service()
    {
        return $this->privates['.service_locator.hEC2953'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 6 => ($this->privates['security.authentication.provider.guard.likes'] ?? $this->getSecurity_Authentication_Provider_Guard_LikesService());
            yield 7 => ($this->privates['security.authentication.provider.guard.comments'] ?? $this->getSecurity_Authentication_Provider_Guard_CommentsService());
        }, 8), true);
